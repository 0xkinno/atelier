...
import { Copy, Check, QrCode, Code, Share2, Menu } from 'lucide-react';
    ...
    <div className="ambient-bg-wash" style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div style={{ flex: 1, padding: '24px 32px 120px 32px', overflowY: 'auto' }} className="dashboard-content-main">
        ...
        <div style={{ display: 'none', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px', paddingBottom: '12px', borderBottom: '1px solid var(--border-light)' }} className="dashboard-mobile-header">
          ...
          <span className="font-display" style={{ fontWeight: 700, fontSize: '1.1rem' }}>Share Kit</span>
        </div>
        ...
        <div className="grid-two-col" style={{ gap: '24px' }}>
          ...
          <div className="card glow-hover" style={{ padding: '28px' }}>
          ...
          <div className="card glow-hover" style={{ padding: '28px' }}>
            ...
            <button onClick={handleDownloadPoster} disabled={isDownloading} className="btn btn-lime btn-sm">
              {isDownloading ? 'Generating PNG...' : 'Download Printable Poster (.PNG)'}
            </button>
          </div>

          {/* Section 3: Embeddable GitHub README Badge */}
          <div className="card glow-hover" style={{ padding: '28px', gridColumn: '1 / -1' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
